...
<div id="tab0"> <a href="#tab0">Metadata</a>
      <div>
      Student Name : ${student.username }<br><br>
...
<div>
	<h4 style="color: red" align="right">${customMsg}</h4> </div> 
	<table border="1" width="80%" align="center">
							...
							<c:forEach var="ops" items="${student.toDisplay}"
								...
								<tr>
									...
									<td style="width: 20%;"><input type="text"
										...
										value="${student.reviewCriteria[counter ].weight }" > /
										${ops.weight }</td>
									<td><input type="text" style="width: 500px;" readonly="readonly"
										value="${student.reviewCriteria[counter ].criteria }">
									</td>
		...
		<input style="width: 80px;" type="submit" value="Submit" ><br/></td></tr>
		</table>
</form>
